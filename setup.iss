...
[Files]
Source: "program\uptime.exe"; DestDir: "{app}"
Source: "program\uptime.exe.config"; DestDir: "{app}"
Source: "program\uptime.pdb"; DestDir: "{app}"
Source: "program\uptime.xml"; DestDir: "{app}"
Source: "program\link.url"; DestDir: "{app}"
Source: "program\mit.txt"; DestDir: "{app}"
Source: "program\postinst-web.bat"; DestDir: "{app}"
Source: "program\unins000.ico"; DestDir: "{app}"
